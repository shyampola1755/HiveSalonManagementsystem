          ...
          campaigns.map((c) => (
            <div key={c._id} className="glass-card p-6 border-slate-200 bg-white flex flex-col justify-between shadow-sm">
              <div>
                ...
                <h3 className="font-bold text-base text-slate-900 mt-3">{c.name}</h3>
                <p className="text-xs text-slate-700 mt-2 p-3 rounded-xl bg-slate-50 border border-slate-100 font-mono">
                  "{c.messageTemplate}"
                </p>
              </div>
