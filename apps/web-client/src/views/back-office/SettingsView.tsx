    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between glass-card p-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-extrabold text-white">System Architecture & Tenant Settings</h2>
            <p className="text-xs text-slate-400">Multi-tenant configuration, RBAC permissions, and MongoDB system status</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="glass-card p-6 border-slate-800 space-y-4">
          ...
          <div className="space-y-2 text-xs">
            <div className="flex justify-between py-2 border-b border-slate-800 text-slate-300">
              ...
              <span className="font-bold text-white">{user?.organization?.name || 'Hive Luxury Salon & Spa'}</span>
            </div>
            <div className="flex justify-between py-2 border-b border-slate-800 text-slate-300">
              <span className="text-slate-400">Org Code:</span>
              <span className="font-bold font-mono text-brand-400">{user?.organization?.code || 'HIVE'}</span>
            </div>
            <div className="flex justify-between py-2 border-b border-slate-800 text-slate-300">
              <span className="text-slate-400">Currency:</span>
              <span className="font-bold text-white">{user?.organization?.currency || 'INR (₹)'}</span>
            </div>
          </div>
        </div>
        ...
        <div className="glass-card p-6 border-slate-800 space-y-4">
          <h3 className="text-sm font-bold text-white flex items-center gap-2">
            <Database className="w-4 h-4 text-emerald-400" /> MERN Stack Environment
          </h3>
          <div className="space-y-2 text-xs">
            <div className="flex justify-between py-2 border-b border-slate-800 text-slate-300">
