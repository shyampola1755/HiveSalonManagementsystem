...
export const seedData = async () => {
  ...
  const customerShyam = await Customer.create({
    organizationId: org._id,
    fullName: 'shyam',
    phone: '9630852147',
  ...
  const invoiceShyam1 = await Invoice.create({
    organizationId: org._id,
    branchId: branchHyd._id,
    invoiceNumber: 'INV-HYD-HYD-01-242362',
    customerId: customerShyam._id,
    customerName: customerShyam.fullName,
    customerPhone: customerShyam.phone,
    ...
    balanceAmount: 0,
    paymentStatus: 'PAID',
    payments: [{ method: 'CASH', amount: 2124, paidAt: today }],
  });
  ...
  await Appointment.create({
    ...
    status: 'COMPLETED',
    totalPrice: 1800,
    invoiceId: invoiceShyam1._id,
  });

  const invoiceShyam2 = await Invoice.create({
    organizationId: org._id,
    branchId: branchHyd._id,
    ...
    balanceAmount: 0,
    paymentStatus: 'PAID',
    payments: [{ method: 'CASH', amount: 7670, paidAt: today }],
  });
  ...
  await Appointment.create({
    ...
    status: 'COMPLETED',
    totalPrice: 6500,
    invoiceId: invoiceShyam2._id,
  });

  const invoiceShyam3 = await Invoice.create({
    organizationId: org._id,
    branchId: branchHyd._id,
